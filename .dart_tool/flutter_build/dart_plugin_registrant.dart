...
import 'package:beacon_scanner_android/beacon_scanner_android.dart' as beacon_scanner_android;
...
import 'package:beacon_scanner_ios/beacon_scanner_ios.dart' as beacon_scanner_ios;
...
class _PluginRegistrant {
  ...
  static void register() {
    if (Platform.isAndroid) {
      try {
        beacon_scanner_android.BeaconScannerAndroid.registerWith();
      } catch (err) {
        print(
          '`beacon_scanner_android` threw an error: $err. '
      ...
      try {
        beacon_scanner_ios.BeaconScannerIOS.registerWith();
      } catch (err) {
        print(
          '`beacon_scanner_ios` threw an error: $err. '
          'The app may not function as expected until you remove this plugin from pubspec.yaml'
        );
      }
